          ...
          <div>
            <div className='row'>
              <div className="col-sm-10 col-sm-offset-1">
                ...
                {userInfo && userInfo.following.indexOf(userProfile._id) === -1 &&
                  <h3>
                    <button className='btn btn-primary' onClick={this.unfollowOrFollowUser.bind([this, '/api/addfollower'])}>Follow +</button>
                  </h3>
                }
                {userInfo && userInfo.following.indexOf(userProfile._id) > -1 &&
                  <h3>
                    <button className='btn btn-danger' onClick={this.unfollowOrFollowUser.bind([this, '/api/removefollower'])}>Unfollow -</button>
                  </h3>
                }
